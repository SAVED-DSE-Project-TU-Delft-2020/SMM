...
centerdistrload = Ax*centermass/(findarea(0,0.14))  #[kg/m] distributed mass in the center
centerdistrload = centerdistrload[:28]               # //


otherdistrload = Ax*(MTOM/2 - centermass)/(findarea(0.14, 1.5))   #[kg/m] distributed mass elsewhere
otherdistrload = otherdistrload[28:]                               #//
