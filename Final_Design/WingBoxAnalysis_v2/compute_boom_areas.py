...
def boomareas(cs_points_x, cs_points_z, mesh, t_sk, A_mainspar, A_aftspar, main_spar_loc, aft_spar_loc, debug):
    ...
    if debug:
        ...
        cs_areas_size[cs_areasloc_x == main_spar_loc] = cs_areas_size[cs_areasloc_x == main_spar_loc] * 2
...
def stiffened_boomareas(cs_areasloc_x, cs_areasloc_z, cs_areasize, stiff_loc_x, stiff_loc_z, cs_stiff_areas):
